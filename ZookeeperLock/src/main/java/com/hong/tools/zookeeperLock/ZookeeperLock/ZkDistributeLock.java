package com.hong.tools.zookeeperLock.ZookeeperLock;
...
public class ZkDistributeLock implements Lock, Watcher {
    ...
    public ZkDistributeLock(String zkServers, String lockName) throws Exception {
     ...
     * @throws Exception 
     */
    public ZkDistributeLock(String zkServers, String lockName, int sessionTimeout) throws Exception {
        if (lockName.contains(LOCK_KEY_SUFFIX)) {
            throw new Exception("lockName 不能包含[" + LOCK_KEY_SUFFIX + "]");
        }
